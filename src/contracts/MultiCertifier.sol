...
contract Certifier {
	...
	function get(address, string) public pure returns (bytes32) {}
	function getAddress(address, string) public pure returns (address) {}
	function getUint(address, string) public pure returns (uint) {}
}
